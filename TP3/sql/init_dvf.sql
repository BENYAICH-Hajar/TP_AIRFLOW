-- Création de la base dédiée aux données DVF
CREATE DATABASE dvf;
...
CREATE INDEX IF NOT EXISTS idx_dvf_raw_commune
    ON dvf_raw(nom_commune);

CREATE INDEX IF NOT EXISTS idx_dvf_raw_type_local
    ON dvf_raw(type_local);

CREATE INDEX IF NOT EXISTS idx_dvf_raw_date
    ON dvf_raw(date_mutation);

CREATE INDEX IF NOT EXISTS idx_dvf_raw_code_postal
    ON dvf_raw(code_postal);

-- =========================================================
-- Table 2 : Agrégats par arrondissement
-- =========================================================
